...
class StatusApiMinimalSetupClass(CustomTestCaseSetup):
    ...
    def setUpTestData(cls):
        ...
        cls.view_name_list = "api:user-status-list"
        cls.view_name_detail = "api:user-status-detail"
    ...
    @staticmethod
    def get_status_query(pk_seq=None, user_id_seq=None):
    ...
    @classmethod
    def get_status_serializers(cls, pk_seq=None, user_id_seq=None):
        status_query = cls.get_status_query(pk_seq, user_id_seq).order_by("id")
...
class StatusApiAuthAndCrudTests(StatusApiFullSetupTestClass):
    ...
    def test_auth_required(self):
        ...
        response = self.client.get(reverse(self.view_name_list,
                                           kwargs={"user_id": self.ws_1_status_1.workspace.created_by}))
    ...
    def test_status_get(self):
        ...
        response_1 = self.client.get(reverse(self.view_name_detail, kwargs={
            "user_id": self.ws_1_status_1.workspace.created_by,
        ...
        ws_1_status_serializers = self.get_status_serializers(
            user_id_seq=[self.ws_1_status_1.workspace.created_by])
